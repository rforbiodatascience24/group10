...
The Gravier data set contains gene expression data from 168 patients, which is used to classify breast cancer patients into diggerent prognostic groups based on survival outcomes.
